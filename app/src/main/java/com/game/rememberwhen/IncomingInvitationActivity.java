...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    private void sendInvitationResponse(String type, String receiverToken) {
        ...
        Toast.makeText(this, receiverToken, Toast.LENGTH_LONG).show();
        try {
    ...
    private void sendRemoteMessage(String remoteMessageBody, String type) {
        System.out.println("SEND REMOTE MESSAGE INCOMING INVITATION ");
        ...
        ApiClient.getClient().create(ApiService.class)
                ...
                .enqueue(new Callback<String>() {
                    ...
                    public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                        Toast.makeText(IncomingInvitationActivity.this, "response " + response.isSuccessful(), Toast.LENGTH_SHORT).show();
