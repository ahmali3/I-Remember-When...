/* Firebase Cloud Messaging handling for video call */
package com.game.rememberwhen.firebase;
...
import com.game.rememberwhen.IncomingInvitationActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (type != null) {
            if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                Intent intent = new Intent(getApplicationContext(), IncomingInvitationActivity.class); // IncomingInvitationActivity.class
